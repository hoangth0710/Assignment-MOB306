    ...
    return (
        <View style={styles.container}>
            <View style={{ flexDirection: 'row' }}>
                ...
                <Text style={{ margin: 5, fontSize: 18, color: '#ff3366' }}>https://www.facebook.com/profile.php?id=100045924112668</Text>
            </View>
            <View style={{ flexDirection: 'row' }}>
                <View style={{justifyContent: 'center', alignItems: 'center', backgroundColor: '#0000ff', marginRight: 10, borderRadius: 10, height: 50, width: 50,}}>
                <Feather name='smartphone' size={30} color='#fff' />
                </View>
                <Text style={{ margin: 5, fontSize: 18, color: '#ff3366' }}>0123456789</Text>
            </View>
